...
public class cfg {
    ...
    public static void save() {
        ...
        try {
            FileWriter writer = new FileWriter(new File(CONFIG_FOLDER, "default.xuy"));
    ...
    public static void load() {
        ...
        try {
            JsonObject object = parser.parse((Reader)new FileReader(new File(CONFIG_FOLDER, "default.xuy"))).getAsJsonObject();
    ...
    static {
        CLIENT_FOLDER = new File(Minecraft.getMinecraft().mcDataDir, "XuyClient");
