...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        roatrage.drawString("X", this.PosX + 3.0f, this.PosY, None.getColor().getRGB());
        roatrage.drawString("uy", this.PosX + 3.0f + (float)roatrage.getStringWidth("X"), this.PosY, -1);
        roatrage.drawString("C", this.PosX + 3.0f + (float)roatrage.getStringWidth("Xuy"), this.PosY, None.getColor().getRGB());
        roatrage.drawString("lient", this.PosX + 3.0f + (float)roatrage.getStringWidth("XuyC"), this.PosY, -1);
