    ...
    public void onUpdate(PlayerHook hook) {
        ...
        for (int i : types) {
            ...
            if (!AutoArmor.isNullOrEmpty(oldArmor)) {
                AutoArmor.mc.playerController.windowClick(0, 8 - i, 0, ClickType.QUICK_MOVE, (EntityPlayer)Minecraft.player);
            }
            AutoArmor.mc.playerController.windowClick(0, j, 0, ClickType.QUICK_MOVE, (EntityPlayer)Minecraft.player);
            break;
        }
    }
