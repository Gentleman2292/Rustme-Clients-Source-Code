...
extends Module {
    ...
    public void onRender3D() {
        ...
        for (int i = 0; i < this.trails.size(); ++i) {
            ...
            RenderUtils.putVertex3d(RenderUtils.getRenderPos(bc.getX(), bc.getY() + (double)Minecraft.player.height, bc.getZ()));
        }
        GL11.glEnd();
    ...
    public void onUpdate(PlayerHook hook) {
        super.onUpdate(hook);
        this.trails.add(new trail(Minecraft.player.lastTickPosX, Minecraft.player.lastTickPosY, Minecraft.player.lastTickPosZ));
    }
