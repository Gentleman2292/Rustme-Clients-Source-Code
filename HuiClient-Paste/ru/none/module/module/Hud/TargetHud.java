...
extends Module {
    ...
    public Entity getTarget() {
        ArrayList<Entity> players = new ArrayList<Entity>(TargetHud.mc.world.loadedEntityList);
        ...
        for (Entity entity : players) {
            ...
            if (!(Minecraft.player.getDistanceToEntity(entity) <= 6.0f) || FriendManager.isFriend(entity.getName())) continue;
            return entity;
        }
        return null;
    }
