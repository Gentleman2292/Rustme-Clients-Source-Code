...
extends Module {
    ...
    public void onUpdate(PlayerHook hook) {
        ...
        switch (this.mode.getVal()) {
            case "Matrix": {
                for (Entity \u0435\u043d\u0442\u0438\u0442\u0438 : AntiBot.mc.world.loadedEntityList) {
                    if (!(\u0435\u043d\u0442\u0438\u0442\u0438 instanceof EntityPlayer) || \u0435\u043d\u0442\u0438\u0442\u0438.ticksExisted > 5 || ((EntityPlayer)\u0435\u043d\u0442\u0438\u0442\u0438).hurtTime <= 0) continue;
                    if (!(Minecraft.player.getDistanceToEntity(\u0435\u043d\u0442\u0438\u0442\u0438) <= 25.0f)) continue;
                    AntiBot.mc.world.removeEntity(\u0435\u043d\u0442\u0438\u0442\u0438);
            ...
            case "Dev": {
                for (Entity entity : AntiBot.mc.world.loadedEntityList) {
                    if (!(entity instanceof EntityPlayer) || entity.ticksExisted > 5) continue;
                    if (entity == Minecraft.player || AntiBot.mc.world.getBlockState(new BlockPos(entity.posX, entity.posY - 0.5, entity.posZ)).getBlock() != Blocks.AIR) continue;
