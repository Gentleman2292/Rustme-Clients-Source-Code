...
extends Module {
    ...
    public WaterMark() {
        ...
        modes.add("Rise");
        modes.add("WexSide");
        this.mode = new ModeSetting("Mode", this, modes, "NoneCode");
    ...
    public void text(String test, int i, float size) {
        ...
        fr2.drawString(test, x + fr2.getStringWidth("  ") * i + 10 - fr2.getStringWidth("N") / 2, y, i == 0 || i == 4 ? None.getColor().getRGB() : -1);
        GL11.glPopMatrix();
    }
    ...
    public void onRender2D() {
        ...
        if (this.mode.getVal().equalsIgnoreCase("NoneCode")) {
            ...
            int x = this.getPosX();
            int y = this.getPosY();
            RenderUtils.drawRect(x, y, x + this.fr.getStringWidth("by zTerrarxd_") + 5, y + 20, new Color(30, 30, 30).getRGB());
            RenderUtils.drawRect(x, y, x + 2, y + 20, None.getColor().getRGB());
            this.fr.drawString("NoneCode", x + 4, y + 1, -1);
            this.fr.drawString("by zTerrarxd_", x + 4, y + 10, -1);
            this.setSizeX(70);
            this.setSizeY(40);
