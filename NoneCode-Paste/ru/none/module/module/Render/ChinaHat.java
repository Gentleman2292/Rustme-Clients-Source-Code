...
extends Module {
    ...
    public void onRender3D() {
        double height;
        super.onRender3D();
        double d = height = this.mc.player.isSneaking() ? -0.1 : 0.12;
        if (this.mc.gameSettings.thirdPersonView == 1 || this.mc.gameSettings.thirdPersonView == 2) {
            ...
            GL11.glTranslatef((float)0.0f, (float)((float)((double)this.mc.player.height + height)), (float)0.0f);
            GL11.glRotatef((float)(-this.mc.player.rotationYaw), (float)0.0f, (float)1.0f, (float)0.0f);
