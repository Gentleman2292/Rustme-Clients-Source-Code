...
extends Module {
    ...
    public void doStrafeAtSpeed(double d) {
        ...
        if (!this.mc.player.isDead) {
            ...
            if (entity != null) {
                ...
                if ((double)Minecraft.getMinecraft().player.getDistanceToEntity(entity) <= (double)this.range.getVal()) {
                ...
                if ((double)Minecraft.getMinecraft().player.getDistanceToEntity(entity) <= 7.0) {
                    // empty if block
                }
    ...
    public Entity getTarget() {
        ...
        players.sort(new Comparator<Entity>(){
            ...
            public int compare(Entity o1, Entity o2) {
                if (((TargetStrafe)TargetStrafe.this).mc.player.getDistanceToEntity(o1) > ((TargetStrafe)TargetStrafe.this).mc.player.getDistanceToEntity(o2)) {
                    return 1;
                }
                if (((TargetStrafe)TargetStrafe.this).mc.player.getDistanceToEntity(o1) < ((TargetStrafe)TargetStrafe.this).mc.player.getDistanceToEntity(o2)) {
                    return -1;
        ...
        for (Entity entity : players) {
            if (!(entity instanceof EntityPlayer) || !(((EntityPlayer)entity).getHealth() > 0.0f) || this.mc.player == entity || !(this.mc.player.getDistanceToEntity(entity) <= 60.0f) || FriendManager.isFriend(entity.getName())) continue;
            return entity;
        }
        return null;
    }
    ...
    public void onUpdate(PlayerHook hook) {
        ...
        if (target != null) {
            ...
            this.mc.player.movementInput.field_192832_b = 0.0f;
    ...
    public float[] getNeededRotations(double x, double y, double z) {
        ...
        double diffY = y + (double)this.mc.player.getEyeHeight() - (this.mc.player.posY + (double)this.mc.player.getEyeHeight()) - 0.4;
